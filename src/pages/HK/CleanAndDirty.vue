<template>
  <q-page class="q-pa-md column">
    <div class="row q-gutter-md flex flex-center q-pa-lg">
      <HKCard card_class="column" card_style="width:230px; height:330px;" radius="5px">
        <div class="column flex">
          <div class="row">
            ...
            <q-btn-dropdown flat dropdown-icon="expand_more" rounded size="15px" class="q-ml-auto">
              <q-list>
          ...
          <div class="text-weight-bold flex items-center justify-center text-h5">Vacant Clean</div>
      ...
      <HKCard card_class="column" card_style="width:230px; height:330px;" radius="5px">
        <div class="column flex">
          ...
          <div class="text-weight-bold flex items-center justify-center text-h5">Out-of-Order</div>
        </div>
      </HKCard>
    </div>
    <!-- <HKTable
...
//   },
//   {
//     name: 'person-in-change',
//     label: 'Person in Change',
//     field: 'personinchange',
//     align: 'left',
//   },
//   {
//     name: 'action',
